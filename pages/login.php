<main class="flex h-full items-center justify-center px-4 py-8">
    <section
        class="flex h-135.5 w-125 flex-col items-center gap-3.75 rounded-[10px] border-[0.5px] border-[#6E6E6E] bg-[#FEFEFE] px-5 py-10">
        ...
        <form class="flex w-full flex-col gap-3.75" action="<?= app_url('/logic/auth_login.php') ?>" method="post">
            ...
            <a href="#" class="text-right text-[15px] font-medium leading-4.25 tracking-[-0.04em] text-[#4C45D1]">
                forgot password?
            </a>
            ...
            <p class="text-center text-[15px] font-medium leading-4.25 tracking-[-0.04em] text-[#6E6E6E]">
                ...
                <a href="<?= app_url('/register') ?>" class="text-[#4C45D1]">Sign up</a>
            </p>
        </form>
    </section>
</main>