<?php
$sidebarItems = [
    ['name' => 'Dashboard', 'icon' => 'assets/dashboard.png', 'page' => 'dashboard'],
    ['name' => 'Info Bus', 'icon' => 'assets/bus.png', 'page' => 'info_bus'],
    ['name' => 'Feedback', 'icon' => 'assets/feedback.png', 'page' => 'feedback'],
];
